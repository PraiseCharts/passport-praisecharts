...
function Strategy(options, verify) {
  options = options || {};
  options.requestTokenURL = options.requestTokenURL || 'https://www.praisecharts.com/api/oauth/request_token';
  options.accessTokenURL = options.accessTokenURL || 'https://www.praisecharts.com/api/oauth/access_token';
  options.userAuthorizationURL = options.userAuthorizationURL || 'https://www.praisecharts.com/api/oauth/authenticate';
  options.sessionKey = options.sessionKey || 'oauth:praisecharts';
  
  OAuthStrategy.call(this, options, verify);
  this.name = 'praisecharts';
  this._userProfileURL = options.userProfileURL || 'https://www.praisecharts.com/api/v1.0/me';
...
Strategy.prototype.userProfile = function(token, tokenSecret, params, done) {
  if (!this._skipExtendedUserProfile) {
    ...
    var profile = { provider: 'praisecharts' };
