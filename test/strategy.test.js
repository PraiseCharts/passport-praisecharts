var chai = require('chai')
  , PraiseChartsStrategy = require('../lib/strategy');
...
describe('Strategy', function() {
  ...
  describe('constructed', function() {
    ...
    it('should be named praisecharts', function() {
      expect(strategy.name).to.equal('praisecharts');
    });
  })
  ...
  describe('constructed with undefined options', function() {
    it('should throw', function() {
      expect(function() {
        var strategy = new PraiseChartsStrategy(undefined, function(){});
      }).to.throw(Error);
    });
  })
  ...
  describe('authorization request', function() {
    ...
    it('should be redirected', function() {
      expect(url).to.equal('https://www.praisecharts.com/api/oauth/authenticate?oauth_token=hh5s93j4hdidpola');
    });
  });
  ...
  describe('authorization request with parameters', function() {
    ...
    it('should be redirected', function() {
      expect(url).to.equal('https://www.praisecharts.com/api/oauth/authenticate?oauth_token=hh5s93j4hdidpola&force_login=true&screen_name=bob');
    });
  });
    ...
    before(function(done) {
      chai.passport.use(strategy)
        ...
        .req(function(req) {
          ...
          req.session = {};
          req.session['oauth:praisecharts'] = {};
          req.session['oauth:praisecharts']['oauth_token'] = 'x-hh5s93j4hdidpola';
          req.session['oauth:praisecharts']['oauth_token_secret'] = 'hdhd0244k9j7ao03';
        })
        .authenticate();
    });
    ...
    before(function(done) {
      chai.passport.use(strategy)
        ...
        .req(function(req) {
          ...
          req.session = {};
          req.session['oauth:praisecharts'] = {};
          req.session['oauth:praisecharts']['oauth_token'] = 'hh5s93j4hdidpola';
          req.session['oauth:praisecharts']['oauth_token_secret'] = 'hdhd0244k9j7ao03';
        })
        .authenticate();
    });
